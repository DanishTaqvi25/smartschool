...
<div class="content-wrapper" style="min-height:946px;">
    <section class="content">
	   ...
	   <p style="text-align:right;"><span style="border:1px solid rgba(72, 94, 144, 0.16);padding: 8px 14px;font-size: 11px;color:rgba(27, 46, 75, 0.7);margin-right:10px;"><i style="color:rgba(27, 46, 75, 0.7);padding-right:10px;" class="fa fa-calendar"></i>EMAIL</span> <span style="border:1px solid rgba(72, 94, 144, 0.16);padding: 8px 14px;font-size: 11px;margin-right:10px;color:rgba(27, 46, 75, 0.7);"><i style="color:black;padding-right:10px;color:rgba(27, 46, 75, 0.7);" class="fa fa-calendar"></i>PRINT</span>  <span style="border:1px solid black;padding: 8px 14px;font-size: 11px;background:#0168fa;color:white;"><i style="color:white;padding-right:10px;" class="fa fa-calendar"></i>GENERATE REPORT</span>  </p>
	   </div>
        ...
        <div class="row">
                ...
                if ($this->rbac->hasPrivilege('fees_awaiting_payment_widegts', 'can_view')) {
                    ...
                    <div  class="col-lg-3 col-md-6 col-sm-6">
                        <div class="topprograssstart">
                            <p style="font-family: 'IBM Plex Sans';" class="text-uppercase mt5 clearfix" ><i style="padding-bottom:10px;" class="fa fa-money ftlayer"></i><?php echo $this->lang->line('fees') . " " . $this->lang->line('awaiting') . " " . $this->lang->line('payment'); ?><br>
							<span style="font-size:25px;font-family: 'IBM Plex Sans';" class="pull-righ"><?php echo $total_paid; ?>/<?php echo $total_fees ?></span>
                            </p>
                            <div style="padding-top:15px;" class="progress-group">
            ...
            if ($this->module_lib->hasActive('front_office')) {
                if ($this->rbac->hasPrivilege('conveted_leads_widegts', 'can_view')) {
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="topprograssstart">
                            <p style="font-family: 'IBM Plex Sans';" class="text-uppercase mt5 clearfix"><i style="padding-bottom:10px;" class="fa fa-ioxhost ftlayer"></i> <?php echo $this->lang->line('converted') . " " . $this->lang->line('leads') ?><br>
							<span style="font-size:25px;" class="pull-righ"><?php echo $total_complete + 0; ?>/<?php echo $total_enquiry; ?></span>
                            </p>
                            <div style="padding-top:15px;" class="progress-group">
                                <div class="progress progress-minibar">
            ...
            if ($this->rbac->hasPrivilege('staff_present_today_widegts', 'can_view')) {
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="topprograssstart">
                        <p style="font-family: 'IBM Plex Sans';" class="text-uppercase mt5 clearfix"><i style="padding-bottom:10px;" class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('staff') . ' ' . $this->lang->line('present') . ' ' . $this->lang->line('today'); ?><br>
						<span style="font-size:25px;" class="pull-righ"><?php echo $Staffattendence_data + 0; ?>/<?php echo $getTotalStaff_data; ?></span>
                        </p> 
                        <div style="padding-top:15px;" class="progress-group">
                            <div class="progress progress-minibar">
            ...
            if ($this->module_lib->hasActive('student_attendance')) {
                if ($this->rbac->hasPrivilege('student_present_today_widegts', 'can_view')) {
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="topprograssstart">
                            <p style="font-family: 'IBM Plex Sans';" class="text-uppercase mt5 clearfix"><i style="padding-bottom:10px;" class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('student') . ' ' . $this->lang->line('present') . ' ' . $this->lang->line('today'); ?><br>
							<span style="font-size:25px;" class="pull-righ"> <?php echo 0 + $attendence_data['total_half_day'] + $attendence_data['total_late'] + $attendence_data['total_present']; ?>/<?php echo $total_students; ?></span>
                            </p>
                            <div style="padding-top:15px;" class="progress-group">
                                <div class="progress progress-minibar">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        ...
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border">
                                <h3 style="font-family: 'IBM Plex Sans';font-size:14px;font-weight: 660;" class="box-title"><?php echo $this->lang->line('fees_collection_&_expenses_for'); ?><?php echo $this->lang->line('_expenses_for') ?> <?php echo $this->lang->line(strtolower(date('F'))) . " " . date('Y');
                            ;
                            ?></h3>
            ...
            if ($this->module_lib->hasActive('income')) {
                if ($this->rbac->hasPrivilege('income_donut_graph', 'can_view')) {
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col40">
                        ...
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border"><h3 style="font-family: 'IBM Plex Sans';font-size:14px;font-weight: 660;" class="box-title"><?php echo $this->lang->line('income') . " - " . $this->lang->line(strtolower(date('F'))) . " " . date('Y');
                    ;
                    ?></h3></div>
...
?>
                ...
                if ($this->rbac->hasPrivilege('fees_collection_and_expense_yearly_chart', 'can_view')) {
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        ...
                        <div class="box box-info borderwhite">
                            <div class="box-header with-border">
                                <h3 style="font-family: 'IBM Plex Sans';font-size:14px;font-weight: 660;" class="box-title"><?php echo $this->lang->line('fees_collection_&_expenses_for_session'); ?> <?php echo $this->setting_model->getCurrentSessionName(); ?></h3>
                                <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                </div>
    ...
    <?php if ($this->rbac->hasPrivilege('expense_donut_graph', 'can_view')) { ?>
                    <div class="col-lg-5 col-md-5 col-sm-12 col40">
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border"><h3 style="font-family: 'IBM Plex Sans';font-size:14px;font-weight: 660;" class="box-title"><?php echo $this->lang->line('expense') . " - " . $this->lang->line(strtolower(date('F'))) . " " . date('Y');
        ;
        ?></h3>
                            </div><!--./info-box--> 
