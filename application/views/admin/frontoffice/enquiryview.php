                        ...
                        <div class="box-body row">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">
                                    <p class="roboto-medium"><?php echo $this->lang->line('enquiry'); ?> <?php echo $this->lang->line('date'); ?></p>
                                    <div class="input-group">
                                        <div style="border-radius: 4px 0px 0px 4px;" class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input style="border:1px solid #c0ccda;height:38px;color:#c0ccda;border-radius: 0px 4px 4px 0px;" type="text" autocomplete="off" name="enquiry_date" class="form-control pull-right date" id="enquiry_date">
                                    </div>
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">  
                                    <p class="roboto-medium" ><?php echo $this->lang->line('source'); ?></p>
                                    <select style="border:1px solid #c0ccda;height:40px;color:#c0ccda;border-radius:0.40rem;"   id="source" name="source" class="form-control" >
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">  
                                    <p class="roboto-medium" ><?php echo $this->lang->line('status'); ?></p>
                                    <select style="border:1px solid #c0ccda;height:40px;color:#c0ccda;border-radius:0.40rem;" id="status" name="status" class="form-control" >
                                        <option style="color:black;" value=""><?php echo $this->lang->line('select') ?></option>
                                        <option style="color:black;" value="all" <?php
                                        if ($status == "all") {
                                            echo "selected";
                                        }
                            ...
                            <div class="box-body">
                                ...
                                <div class="mailbox-messages">
                                    <div class="table-responsive">  
                                        <table style="border:1px solid #ced8e4;" class="table table-hover table-striped table-bordered" id="enquirytable">
                                            <thead>
                                                <tr style="border:1px solid #ced8e4;">
